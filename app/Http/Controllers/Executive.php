...
class Executive extends Controller
{
    ...
    function report($id){
        ...
        return view('Executive.projectDetail',compact('user','project','projectYear','projectType','projectCharector','projectIntegrat','projectOBJ','projectTarget','projectStep','projectBadgetType','projectUniPlan','projectCostQuarter','peojectEXP','projectCostType','projectBenefit'));
    }
