                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form method="POST" action="{{route('costs.update',$cost_types->costID)}}"novalidate enctype="multipart/form-data">
                                        @csrf
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" type="textt" name="costname" id="name"
                                                    required='required' data-validate-length-range="8,20" value="{{$cost_types->costname}}" />
                                                @error('costname')
                                                    <div class="m-2">
