    ...
    <div class="main_container">
        <div role="main">
            <div class="">
                ...
                @include('DateReportQuarter.create')
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($data['date'] as $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->endDate}}</td>
                                                <td>
                                                    <a href="{{ route('dateReportQuarter.edit', $item->drqID) }}">
                                                        <i class="fa fa-pencil btn btn-warning
                                                        "></i></a>
                                                    <a href="{{ route('dateReportQuarter.delete', $item->drqID) }}"
                                                        onclick="return confirm('ต้องการลบกำหนดการปี {{ $item->year->year }} {{$item->quarter->name}} หรือไม่')">
