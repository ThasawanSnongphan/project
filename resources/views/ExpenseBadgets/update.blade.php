                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form method="POST" action="{{ route('ex.update', $expanse->expID) }}"
                                        ...
                                        <div class="ln_solid">
                                            <div class="form-group text-center p-2">
                                                <div class="col-md-6 offset-md-3">
                                                    ...
                                                    <button type='reset' class="btn btn-danger"><a href="/Expense" style="color: white">Back</a></button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
