                                                    ...
                                                    @foreach ($project as $item)
                                                        <tr>
                                                            ...
                                                            <td data-project="{{ $item->proID }}">
                                                                @if ($item->statusID == 6)
                                                                    <a
                                                                        href="{{ route('PlanningAnalyst.detailEvaluation', $item->proID) }}">{{ $item->name }}</a>
                                                                @elseif($item->statusID == 2)
                                                                    <a
                                                                        href="{{ route('PlanningAnalyst.detail', $item->proID) }}">{{ $item->name }}</a>
                                                                @endif
                                                            </td>
