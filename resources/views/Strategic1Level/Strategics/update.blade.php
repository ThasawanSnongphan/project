                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10 col-sm-10">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form method="POST" action="{{ route('strategic1LV.update', $strategic->stra1LVID) }}"
                                        ...
                                        <div class="ln_solid">
                                            <div class="form-group text-center p-2">
                                                <div class="col-md-6 offset-md-3">
                                                    ...
                                                    <a href="/strategic1LV" style="color: white"><button type='button' class="btn btn-danger">Back</button></a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
