    ...
    <div class="main_container">
        ...
        <div role="main">
            <div class="">
                ...
                @include('Strategic2Level.Strategics.create')
                                ...
                                <tbody>
                                    ...
                                    @foreach ($sortedStrategic as $stra)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('strategic2LV.edit', $stra->stra2LVID) }}">
                                                    <i class="fa fa-pencil btn btn-warning"></i>
                                                </a>
                                                <a href="{{ route('strategic2LV.delete', $stra->stra2LVID) }}"
                                                    onclick="return confirm('ต้องการลบ {{ $stra->name }} หรือไม่')">
                                                    <i class="fa fa-times btn btn-danger"></i>
                                                </a>
                                                <a href="{{route('copyPlan',[$stra->stra2LVID,2])}}">copy</a>
                                            </td>
                                        </tr>
                                        @php
                                            $i++;
