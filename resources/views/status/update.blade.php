                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form method="POST" action="{{route('status.update',$status->statusID)}}"novalidate enctype="multipart/form-data">
                                        @csrf
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" type="textt" name="name" id="name"
                                                    required='required' data-validate-length-range="8,20" value="{{$status->name}}"  />
                                                @error('name')
                                                    <div class="m-2">
